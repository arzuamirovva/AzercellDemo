...
//                                .anyRequest().hasRole("ADMIN")
                                ...
                                .requestMatchers("/prize/**").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT,"/billing/**").authenticated()
                                ...
                                .requestMatchers(HttpMethod.PUT,"/numbers/increase/balance").authenticated()
                                .requestMatchers(HttpMethod.PUT, "/numbers/status/{id}").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/numbers/own/status/").authenticated()
                                .requestMatchers(HttpMethod.DELETE, "/numbers/{id}").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/numbers/remove-tariff/{id}").authenticated()
